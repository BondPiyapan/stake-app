...
import DetailEngineer from '../screen/Main/Engineer/DetailEngineer';
import DetailCompany from '../screen/Main/Engineer/DetailCompany';
//Scene
...
const Main = createStackNavigator(
  {
    ...
    DetailEngineer: {
      ...
      navigationOptions: ({ navigation }) => ({
        headerTintColor: '#000',
        title: <Text style={{ fontFamily: 'sukhumvit-set-bold', fontSize: 20 }}>รายละเอียดเสาเข็ม</Text>,
      })
    },
    DetailCompany: {
      ...
      navigationOptions: ({ navigation }) => ({
        headerTintColor: '#000',
        title: <Text style={{ fontFamily: 'sukhumvit-set-bold', fontSize: 20 }}>รายละเอียดบริษัท</Text>,
      })
    },
